...
The attribute `flashSession` is how the flash was previously set into the dependency injection container. You need to start the [session](/3.3/en/session) first to successfully use the `flashSession` messenger.

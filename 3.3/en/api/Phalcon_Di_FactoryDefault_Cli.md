...
*extends* class [Phalcon\Di\FactoryDefault](/3.3/en/api/Phalcon_Di_FactoryDefault)

*implements* [Phalcon\DiInterface](/3.3/en/api/Phalcon_DiInterface), [ArrayAccess](http://php.net/manual/en/class.arrayaccess.php)

<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/di/factorydefault/cli.zep" class="btn btn-default btn-sm">Source on GitHub</a>

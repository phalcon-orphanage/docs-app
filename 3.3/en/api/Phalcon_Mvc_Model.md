...
*implements* [Phalcon\Mvc\EntityInterface](/3.3/en/api/Phalcon_Mvc_EntityInterface), [Phalcon\Mvc\ModelInterface](/3.3/en/api/Phalcon_Mvc_ModelInterface), [Phalcon\Mvc\Model\ResultInterface](/3.3/en/api/Phalcon_Mvc_Model_ResultInterface), [Phalcon\Di\InjectionAwareInterface](/3.3/en/api/Phalcon_Di_InjectionAwareInterface), [Serializable](http://php.net/manual/en/class.serializable.php), [JsonSerializable](http://php.net/manual/en/class.jsonserializable.php)

<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/mvc/model.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
## Methods
final public  **__construct** ([*mixed* $data], [[Phalcon\DiInterface](/3.3/en/api/Phalcon_DiInterface) $dependencyInjector], [[Phalcon\Mvc\Model\ManagerInterface](/3.3/en/api/Phalcon_Mvc_Model_ManagerInterface) $modelsManager])
...
protected  **setEventsManager** ([Phalcon\Events\ManagerInterface](/3.3/en/api/Phalcon_Events_ManagerInterface) $eventsManager)
...
public  **setTransaction** ([Phalcon\Mvc\Model\TransactionInterface](/3.3/en/api/Phalcon_Mvc_Model_TransactionInterface) $transaction)
...
public [Phalcon\Mvc\Model](/3.3/en/api/Phalcon_Mvc_Model) **assign** (*array* $data, [*mixed* $dataColumnMap], [*array* $whiteList])
...
public static  **cloneResultMap** ([Phalcon\Mvc\ModelInterface](/3.3/en/api/Phalcon_Mvc_ModelInterface) | [Phalcon\Mvc\Model\Row](/3.3/en/api/Phalcon_Mvc_Model_Row) $base, *array* $data, *array* $columnMap, [*int* $dirtyState], [*boolean* $keepSnapshots])
...
public static [Phalcon\Mvc\ModelInterface](/3.3/en/api/Phalcon_Mvc_ModelInterface) **cloneResult** ([Phalcon\Mvc\ModelInterface](/3.3/en/api/Phalcon_Mvc_ModelInterface) $base, *array* $data, [*int* $dirtyState])
...
public static  **query** ([[Phalcon\DiInterface](/3.3/en/api/Phalcon_DiInterface) $dependencyInjector])

Create a criteria for a specific model



protected *boolean* **_exists** ([Phalcon\Mvc\Model\MetaDataInterface](/3.3/en/api/Phalcon_Mvc_Model_MetaDataInterface) $metaData, [Phalcon\Db\AdapterInterface](/3.3/en/api/Phalcon_Db_AdapterInterface) $connection, [*string* | *array* $table])

Checks whether the current record already exists



protected static [Phalcon\Mvc\Model\ResultsetInterface](/3.3/en/api/Phalcon_Mvc_Model_ResultsetInterface) **_groupResult** (*mixed* $functionName, *string* $alias, *array* $parameters)
...
public  **appendMessage** ([Phalcon\Mvc\Model\MessageInterface](/3.3/en/api/Phalcon_Mvc_Model_MessageInterface) $message)
...
protected  **validate** ([Phalcon\ValidationInterface](/3.3/en/api/Phalcon_ValidationInterface) $validator)
...
protected  **_preSave** ([Phalcon\Mvc\Model\MetaDataInterface](/3.3/en/api/Phalcon_Mvc_Model_MetaDataInterface) $metaData, *mixed* $exists, *mixed* $identityField)
...
protected *boolean* **_doLowInsert** ([Phalcon\Mvc\Model\MetaDataInterface](/3.3/en/api/Phalcon_Mvc_Model_MetaDataInterface) $metaData, [Phalcon\Db\AdapterInterface](/3.3/en/api/Phalcon_Db_AdapterInterface) $connection, *string* | *array* $table, *boolean* | *string* $identityField)

Sends a pre-build INSERT SQL statement to the relational database system



protected *boolean* **_doLowUpdate** ([Phalcon\Mvc\Model\MetaDataInterface](/3.3/en/api/Phalcon_Mvc_Model_MetaDataInterface) $metaData, [Phalcon\Db\AdapterInterface](/3.3/en/api/Phalcon_Db_AdapterInterface) $connection, *string* | *array* $table)

Sends a pre-build UPDATE SQL statement to the relational database system



protected *boolean* **_preSaveRelatedRecords** ([Phalcon\Db\AdapterInterface](/3.3/en/api/Phalcon_Db_AdapterInterface) $connection, [Phalcon\Mvc\ModelInterface](/3.3/en/api/Phalcon_Mvc_ModelInterface) $related)

Saves related records that must be stored prior to save the master record



protected *boolean* **_postSaveRelatedRecords** ([Phalcon\Db\AdapterInterface](/3.3/en/api/Phalcon_Db_AdapterInterface) $connection, [Phalcon\Mvc\ModelInterface](/3.3/en/api/Phalcon_Mvc_ModelInterface) $related)
...
protected [Phalcon\Mvc\Model\Relation](/3.3/en/api/Phalcon_Mvc_Model_Relation) **hasManyToMany** (*string* | *array* $fields, *string* $intermediateModel, *string* | *array* $intermediateFields, *string* | *array* $intermediateReferencedFields, *mixed* $referenceModel, *string* | *array* $referencedFields, [*array* $options])
...
public  **addBehavior** ([Phalcon\Mvc\Model\BehaviorInterface](/3.3/en/api/Phalcon_Mvc_Model_BehaviorInterface) $behavior)
...
public [Phalcon\Mvc\Model\ResultsetInterface](/3.3/en/api/Phalcon_Mvc_Model_ResultsetInterface) **getRelated** (*string* $alias, [*array* $arguments])
...
final protected static [Phalcon\Mvc\ModelInterface](/3.3/en/api/Phalcon_Mvc_ModelInterface) | [Phalcon\Mvc\ModelInterface](/3.3/en/api/Phalcon_Mvc_ModelInterface) | *boolean* **_invokeFinder** (*string* $method, *array* $arguments)
...
public [Phalcon\Mvc\Model\Resultset](/3.3/en/api/Phalcon_Mvc_Model_Resultset) | [Phalcon\Mvc\Model](/3.3/en/api/Phalcon_Mvc_Model) **__get** (*string* $property)

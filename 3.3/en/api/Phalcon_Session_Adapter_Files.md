...
<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/session/adapter/files.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
## Methods
public  **__construct** ([*array* $options]) inherited from [Phalcon\Session\Adapter](/3.3/en/api/Phalcon_Session_Adapter)
...
public  **destroy** ([*mixed* $removeData]) inherited from [Phalcon\Session\Adapter](/3.3/en/api/Phalcon_Session_Adapter)

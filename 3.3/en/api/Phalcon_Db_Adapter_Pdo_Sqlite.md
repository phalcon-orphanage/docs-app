...
*extends* abstract class [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)
...
<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/db/adapter/pdo/sqlite.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public [Phalcon\Db\IndexInterface](/3.3/en/api/Phalcon_Db_IndexInterface) **describeIndexes** (*string* $table, [*string* $schema])
...
public [Phalcon\Db\ReferenceInterface](/3.3/en/api/Phalcon_Db_ReferenceInterface) **describeReferences** (*string* $table, [*string* $schema])
...
public  **__construct** (*array* $descriptor) inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)

Constructor for Phalcon\Db\Adapter\Pdo



public  **prepare** (*mixed* $sqlStatement) inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)
...
public [PDOStatement](http://php.net/manual/en/class.pdostatement.php) **executePrepared** ([PDOStatement](http://php.net/manual/en/class.pdostatement.php) $statement, *array* $placeholders, *array* $dataTypes) inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)
...
public  **query** (*mixed* $sqlStatement, [*mixed* $bindParams], [*mixed* $bindTypes]) inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)
...
public  **execute** (*mixed* $sqlStatement, [*mixed* $bindParams], [*mixed* $bindTypes]) inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)
...
public  **affectedRows** () inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)
...
public  **close** () inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)
...
public  **escapeString** (*mixed* $str) inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)
...
public  **convertBoundParams** (*mixed* $sql, [*array* $params]) inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)
...
public *int* | *boolean* **lastInsertId** ([*string* $sequenceName]) inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)
...
public  **begin** ([*mixed* $nesting]) inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)

Starts a transaction in the connection



public  **rollback** ([*mixed* $nesting]) inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)

Rollbacks the active transaction in the connection



public  **commit** ([*mixed* $nesting]) inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)

Commits the active transaction in the connection



public  **getTransactionLevel** () inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)

Returns the current transaction nesting level



public  **isUnderTransaction** () inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)
...
public  **getInternalHandler** () inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)

Return internal PDO handler



public *array* **getErrorInfo** () inherited from [Phalcon\Db\Adapter\Pdo](/3.3/en/api/Phalcon_Db_Adapter_Pdo)

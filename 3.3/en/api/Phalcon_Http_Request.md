...
*implements* [Phalcon\Http\RequestInterface](/3.3/en/api/Phalcon_Http_RequestInterface), [Phalcon\Di\InjectionAwareInterface](/3.3/en/api/Phalcon_Di_InjectionAwareInterface)

<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/http/request.zep" class="btn btn-default btn-sm">Source on GitHub</a>

...
<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/mvc/view/engine/volt/compiler.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
## Methods
public  **__construct** ([[Phalcon\Mvc\ViewBaseInterface](/3.3/en/api/Phalcon_Mvc_ViewBaseInterface) $view])

...
<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/validation/combinedfieldsvalidator.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
abstract public  **validate** ([Phalcon\Validation](/3.3/en/api/Phalcon_Validation) $validation, *mixed* $attribute) inherited from [Phalcon\Validation\Validator](/3.3/en/api/Phalcon_Validation_Validator)

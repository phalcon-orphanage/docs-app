...
*implements* [Phalcon\Di\InjectionAwareInterface](/3.3/en/api/Phalcon_Di_InjectionAwareInterface), [Phalcon\Mvc\RouterInterface](/3.3/en/api/Phalcon_Mvc_RouterInterface), [Phalcon\Events\EventsAwareInterface](/3.3/en/api/Phalcon_Events_EventsAwareInterface)

<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/mvc/router.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public  **mount** ([Phalcon\Mvc\Router\GroupInterface](/3.3/en/api/Phalcon_Mvc_Router_GroupInterface) $group)

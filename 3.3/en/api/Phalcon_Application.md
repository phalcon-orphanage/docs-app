...
<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/application.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public  **__get** (*string* $propertyName) inherited from [Phalcon\Di\Injectable](/3.3/en/api/Phalcon_Di_Injectable)

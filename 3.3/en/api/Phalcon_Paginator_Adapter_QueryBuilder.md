...
<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/paginator/adapter/querybuilder.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public  **setQueryBuilder** ([Phalcon\Mvc\Model\Query\Builder](/3.3/en/api/Phalcon_Mvc_Model_Query_Builder) $builder)

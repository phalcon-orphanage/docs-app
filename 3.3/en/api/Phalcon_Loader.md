...
<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/loader.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public **setFileCheckingCallback** (*mixed* $callback = null): [Phalcon\Loader](/3.3/en/api/Phalcon_Loader)
...
A [Phalcon\Loader\Exception](/3.3/en/api/Phalcon_Loader_Exception) is thrown if the $callback parameter is not a `callable` or `null`;

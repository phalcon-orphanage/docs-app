...
*implements* [Phalcon\Cache\BackendInterface](/3.3/en/api/Phalcon_Cache_BackendInterface), [Serializable](http://php.net/manual/en/class.serializable.php)

<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/cache/backend/memory.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public  **__construct** ([Phalcon\Cache\FrontendInterface](/3.3/en/api/Phalcon_Cache_FrontendInterface) $frontend, [*array* $options]) inherited from [Phalcon\Cache\Backend](/3.3/en/api/Phalcon_Cache_Backend)

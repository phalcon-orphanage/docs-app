...
*implements* [Phalcon\Events\ManagerInterface](/3.3/en/api/Phalcon_Events_ManagerInterface)

<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/events/manager.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
final public *mixed* **fireQueue** ([SplPriorityQueue](http://php.net/manual/en/class.splpriorityqueue.php) | *array* $queue, [Phalcon\Events\Event](/3.3/en/api/Phalcon_Events_Event) $event)

...
<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/tag.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public static  **setDI** ([Phalcon\DiInterface](/3.3/en/api/Phalcon_DiInterface) $dependencyInjector)

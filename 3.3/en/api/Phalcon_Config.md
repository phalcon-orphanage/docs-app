...
<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/config.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public  **merge** ([Phalcon\Config](/3.3/en/api/Phalcon_Config) $config)

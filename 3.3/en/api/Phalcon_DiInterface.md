...
<a href="https://github.com/phalcon/cphalcon/tree/v3.3.0/phalcon/diinterface.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
abstract public  **setRaw** (*mixed* $name, [Phalcon\Di\ServiceInterface](/3.3/en/api/Phalcon_Di_ServiceInterface) $rawDefinition)
...
abstract public static  **setDefault** ([Phalcon\DiInterface](/3.3/en/api/Phalcon_DiInterface) $dependencyInjector)

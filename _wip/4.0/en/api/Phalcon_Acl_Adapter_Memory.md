...
public  **addResource** ([Phalcon\Acl\Resource](/4.0/en/api/Phalcon_Acl_Resource) | *string* $resourceValue, *array* | *string* $accessList)
...
public  **getActiveRole** () inherited from [Phalcon\Acl\Adapter](/4.0/en/api/Phalcon_Acl_Adapter)

Role which the list is checking if it's allowed to certain resource/access



public  **getActiveResource** () inherited from [Phalcon\Acl\Adapter](/4.0/en/api/Phalcon_Acl_Adapter)

...
## Methods
public  **__construct** ([Phalcon\Db\AdapterInterface](/4.0/en/api/Phalcon_Db_AdapterInterface) $connection, [PDOStatement](http://php.net/manual/en/class.pdostatement.php) $result, [*string* $sqlStatement], [*array* $bindParams], [*array* $bindTypes])

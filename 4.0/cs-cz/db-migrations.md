...
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |:--------:|
| `type`          | Column type. Must be a [Phalcon\Db\Column](api/Phalcon_Db_Column) constant (see below)                                                   |    Ne    |
| `size`          | Some type of columns like VARCHAR or INTEGER may have a specific size                                                                      |   Ano    |
| `scale`         | DECIMAL or NUMBER columns may be have a scale to specify how much decimals it must store                                                   |   Ano    |
...
| ------------------- | --------------------------------------------------------------------------------------------------- |:--------:| ---------------- |
| `referencedTable`   | It's auto-descriptive. It refers to the name of the referenced table.                               |    Ne    | All              |
| `columns`           | An array with the name of the columns at the table that have the reference                          |    Ne    | All              |
| `referencedColumns` | An array with the name of the columns at the referenced table                                       |    Ne    | All              |
| `referencedSchema`  | The referenced table maybe is on another schema or database. This option allows you to define that. |   Ano    | All              |
| `onDelete`          | If the foreign record is removed, perform this action on the local record(s).                       |   Ano    | MySQL PostgreSQL |
| `onUpdate`          | If the foreign record is updated, perform this action on the local record(s).                       |   Ano    | MySQL PostgreSQL |

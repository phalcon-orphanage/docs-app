...
*extends* abstract class [Phalcon\Validation\CombinedFieldsValidator](api/Phalcon_Validation_CombinedFieldsValidator)

*implements* [Phalcon\Validation\ValidatorInterface](api/Phalcon_Validation_ValidatorInterface)

<a href="https://github.com/phalcon/cphalcon/tree/v4.0.0/phalcon/validation/validator/uniqueness.zep" class="btn btn-default btn-sm">Código fuente en GitHub</a>
...
protected **isUniqueness** ([Phalcon\Validation](api/Phalcon_Validation) $validation, *mixed* $field)

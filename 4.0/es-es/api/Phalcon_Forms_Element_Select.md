...
<a href="https://github.com/phalcon/cphalcon/tree/v4.0.0/phalcon/forms/element/select.zep" class="btn btn-default btn-sm">Código fuente en GitHub</a>
...
public [Phalcon\Forms\Element](/4.0/en/api/Phalcon_Forms_Element) **setOptions** (*array* | *object* $options)

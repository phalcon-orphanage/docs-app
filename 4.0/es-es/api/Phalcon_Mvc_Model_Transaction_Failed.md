...
*extends* class [Phalcon\Mvc\Model\Transaction\Exception](api/Phalcon_Mvc_Model_Transaction_Exception)

*implements* [Throwable](https://php.net/manual/en/class.throwable.php)

<a href="https://github.com/phalcon/cphalcon/tree/v4.0.0/phalcon/mvc/model/transaction/failed.zep" class="btn btn-default btn-sm">Código fuente en GitHub</a>

This class will be thrown to exit a try/catch block for isolated transactions

## Métodos

public **__construct** (*mixed* $message, [[Phalcon\Mvc\ModelInterface](api/Phalcon_Mvc_ModelInterface) $record])

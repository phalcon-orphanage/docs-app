...
<a href="https://github.com/phalcon/cphalcon/tree/v4.0.0/phalcon/validation/validator/file.zep" class="btn btn-default btn-sm">Código fuente en GitHub</a>
...
public **isAllowEmpty** ([Phalcon\Validation](api/Phalcon_Validation) $validation, *mixed* $field)

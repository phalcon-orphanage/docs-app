...
<a href="https://github.com/phalcon/cphalcon/tree/v4.0.0/phalcon/validation/message/group.zep" class="btn btn-default btn-sm">Código fuente en GitHub</a>
...
public [Phalcon\Validation\Message](api/Phalcon_Validation_Message) **offsetGet** (*int* $index)
...
public **offsetSet** (*int* $index, [Phalcon\Validation\Message](api/Phalcon_Validation_Message) $message)
...
public **appendMessages** ([Phalcon\Validation\MessageInterface](api/Phalcon_Validation_MessageInterface) $messages)
...
public static [Phalcon\Validation\Message\Group](api/Phalcon_Validation_Message_Group) **__set_state** (*array* $group)

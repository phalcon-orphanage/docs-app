...
<a href="https://github.com/phalcon/cphalcon/tree/v4.0.0/phalcon/di.zep" class="btn btn-default btn-sm">Исходный код на GitHub</a>
...
public **setInternalEventsManager** ([Phalcon\Events\ManagerInterface](api/Phalcon_Events_ManagerInterface) $eventsManager)
...
public **setRaw** (*mixed* $name, [Phalcon\Di\ServiceInterface](api/Phalcon_Di_ServiceInterface) $rawDefinition)
...
public **register** ([Phalcon\Di\ServiceProviderInterface](api/Phalcon_Di_ServiceProviderInterface) $provider)
...
public static **setDefault** ([Phalcon\DiInterface](api/Phalcon_DiInterface) $dependencyInjector)
...
protected **loadFromConfig** ([Phalcon\Config](api/Phalcon_Config) $config)

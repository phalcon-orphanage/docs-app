...
<a name='validation'></a>
## Validation
Phalcon forms are integrated with the [validation](/3.2/en/validation) component to offer instant validation. Built-in or custom validators could be set to each element:
...
<h5 class='alert alert-info' markdown='1'>Learn more about filtering in Phalcon by reading the [Filter documentation](/3.2/en/filter) </h5>

...
*extends* abstract class [Phalcon\Db\Adapter](/3.2/en/api/Phalcon_Db_Adapter)

*implements* [Phalcon\Events\EventsAwareInterface](/3.2/en/api/Phalcon_Events_EventsAwareInterface), [Phalcon\Db\AdapterInterface](/3.2/en/api/Phalcon_Db_AdapterInterface)

<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/db/adapter/pdo.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public [Phalcon\Db\Index](/3.2/en/api/Phalcon_Db_Index) **describeIndexes** (*string* $table, [*string* $schema]) inherited from [Phalcon\Db\Adapter](/3.2/en/api/Phalcon_Db_Adapter)
...
public  **describeReferences** (*mixed* $table, [*mixed* $schema]) inherited from [Phalcon\Db\Adapter](/3.2/en/api/Phalcon_Db_Adapter)
...
public  **getDefaultValue** () inherited from [Phalcon\Db\Adapter](/3.2/en/api/Phalcon_Db_Adapter)
...
public  **useExplicitIdValue** () inherited from [Phalcon\Db\Adapter](/3.2/en/api/Phalcon_Db_Adapter)

...
*implements* [Phalcon\Events\EventsAwareInterface](/3.2/en/api/Phalcon_Events_EventsAwareInterface), [Phalcon\Di\InjectionAwareInterface](/3.2/en/api/Phalcon_Di_InjectionAwareInterface), [Countable](http://php.net/manual/en/class.countable.php), [Iterator](http://php.net/manual/en/class.iterator.php), [Traversable](http://php.net/manual/en/class.traversable.php)

<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/forms/form.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public  **add** ([Phalcon\Forms\ElementInterface](/3.2/en/api/Phalcon_Forms_ElementInterface) $element, [*mixed* $position], [*mixed* $type])

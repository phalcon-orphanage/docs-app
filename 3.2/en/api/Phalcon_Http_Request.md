...
*implements* [Phalcon\Http\RequestInterface](/3.2/en/api/Phalcon_Http_RequestInterface), [Phalcon\Di\InjectionAwareInterface](/3.2/en/api/Phalcon_Di_InjectionAwareInterface)

<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/http/request.zep" class="btn btn-default btn-sm">Source on GitHub</a>

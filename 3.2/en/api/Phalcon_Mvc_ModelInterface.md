...
<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/mvc/modelinterface.zep" class="btn btn-default btn-sm">Source on GitHub</a>

## Methods
abstract public  **setTransaction** ([Phalcon\Mvc\Model\TransactionInterface](/3.2/en/api/Phalcon_Mvc_Model_TransactionInterface) $transaction)
...
abstract public static  **cloneResult** ([Phalcon\Mvc\ModelInterface](/3.2/en/api/Phalcon_Mvc_ModelInterface) $base, *array* $data, [*mixed* $dirtyState])
...
abstract public static  **query** ([[Phalcon\DiInterface](/3.2/en/api/Phalcon_DiInterface) $dependencyInjector])
...
abstract public  **appendMessage** ([Phalcon\Mvc\Model\MessageInterface](/3.2/en/api/Phalcon_Mvc_Model_MessageInterface) $message)

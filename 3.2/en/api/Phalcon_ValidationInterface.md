...
<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/validationinterface.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
abstract public  **add** (*mixed* $field, [Phalcon\Validation\ValidatorInterface](/3.2/en/api/Phalcon_Validation_ValidatorInterface) $validator)

...


abstract public  **rule** (*mixed* $field, [Phalcon\Validation\ValidatorInterface](/3.2/en/api/Phalcon_Validation_ValidatorInterface) $validator)

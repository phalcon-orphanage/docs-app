...
*implements* [Phalcon\Di\InjectionAwareInterface](/3.2/en/api/Phalcon_Di_InjectionAwareInterface), [Phalcon\Session\BagInterface](/3.2/en/api/Phalcon_Session_BagInterface), [IteratorAggregate](http://php.net/manual/en/class.iteratoraggregate.php), [Traversable](http://php.net/manual/en/class.traversable.php), [ArrayAccess](http://php.net/manual/en/class.arrayaccess.php), [Countable](http://php.net/manual/en/class.countable.php)

<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/session/bag.zep" class="btn btn-default btn-sm">Source on GitHub</a>

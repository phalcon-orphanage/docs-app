...
<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/queue/beanstalk/job.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public  **__construct** ([Phalcon\Queue\Beanstalk](/3.2/en/api/Phalcon_Queue_Beanstalk) $queue, *mixed* $id, *mixed* $body)

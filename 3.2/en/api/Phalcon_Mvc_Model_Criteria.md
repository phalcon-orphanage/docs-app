...
*implements* [Phalcon\Mvc\Model\CriteriaInterface](/3.2/en/api/Phalcon_Mvc_Model_CriteriaInterface), [Phalcon\Di\InjectionAwareInterface](/3.2/en/api/Phalcon_Di_InjectionAwareInterface)

<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/mvc/model/criteria.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public [Phalcon\Mvc\Model\Criteria](/3.2/en/api/Phalcon_Mvc_Model_Criteria) **columns** (*string* | *array* $columns)
...
public static  **fromInput** ([Phalcon\DiInterface](/3.2/en/api/Phalcon_DiInterface) $dependencyInjector, *mixed* $modelName, *array* $data, [*mixed* $operator])

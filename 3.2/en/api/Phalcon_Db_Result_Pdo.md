...
*implements* [Phalcon\Db\ResultInterface](/3.2/en/api/Phalcon_Db_ResultInterface)

<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/db/result/pdo.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
## Methods
public  **__construct** ([Phalcon\Db\AdapterInterface](/3.2/en/api/Phalcon_Db_AdapterInterface) $connection, [PDOStatement](http://php.net/manual/en/class.pdostatement.php) $result, [*string* $sqlStatement], [*array* $bindParams], [*array* $bindTypes])

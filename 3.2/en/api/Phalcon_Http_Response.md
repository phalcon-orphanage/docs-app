...
*implements* [Phalcon\Http\ResponseInterface](/3.2/en/api/Phalcon_Http_ResponseInterface), [Phalcon\Di\InjectionAwareInterface](/3.2/en/api/Phalcon_Di_InjectionAwareInterface)

<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/http/response.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public  **setHeaders** ([Phalcon\Http\Response\HeadersInterface](/3.2/en/api/Phalcon_Http_Response_HeadersInterface) $headers)
...
public  **setCookies** ([Phalcon\Http\Response\CookiesInterface](/3.2/en/api/Phalcon_Http_Response_CookiesInterface) $cookies)

Sets a cookies bag for the response externally



public [Phalcon\Http\Response\CookiesInterface](/3.2/en/api/Phalcon_Http_Response_CookiesInterface) **getCookies** ()

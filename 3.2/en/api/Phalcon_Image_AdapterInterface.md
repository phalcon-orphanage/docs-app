...
<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/image/adapterinterface.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
abstract public  **watermark** ([Phalcon\Image\Adapter](/3.2/en/api/Phalcon_Image_Adapter) $watermark, [*mixed* $offsetX], [*mixed* $offsetY], [*mixed* $opacity])
...
abstract public  **mask** ([Phalcon\Image\Adapter](/3.2/en/api/Phalcon_Image_Adapter) $watermark)

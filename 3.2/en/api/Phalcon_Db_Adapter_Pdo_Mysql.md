...
<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/db/adapter/pdo/mysql.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public  **connect** ([*array* $descriptor]) inherited from [Phalcon\Db\Adapter\Pdo](/3.2/en/api/Phalcon_Db_Adapter_Pdo)

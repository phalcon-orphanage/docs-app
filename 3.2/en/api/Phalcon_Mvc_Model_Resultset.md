...
## Methods
public  **__construct** ([Phalcon\Db\ResultInterface](/3.2/en/api/Phalcon_Db_ResultInterface) | *false* $result, [[Phalcon\Cache\BackendInterface](/3.2/en/api/Phalcon_Cache_BackendInterface) $cache])
...
public  **offsetSet** (*int* $index, [Phalcon\Mvc\ModelInterface](/3.2/en/api/Phalcon_Mvc_ModelInterface) $value)
...
public [Phalcon\Mvc\Model](/3.2/en/api/Phalcon_Mvc_Model) **filter** (*callback* $filter)
...
abstract public  **toArray** () inherited from [Phalcon\Mvc\Model\ResultsetInterface](/3.2/en/api/Phalcon_Mvc_Model_ResultsetInterface)

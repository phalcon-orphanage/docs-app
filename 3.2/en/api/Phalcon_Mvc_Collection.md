...
*implements* [Phalcon\Mvc\EntityInterface](/3.2/en/api/Phalcon_Mvc_EntityInterface), [Phalcon\Mvc\CollectionInterface](/3.2/en/api/Phalcon_Mvc_CollectionInterface), [Phalcon\Di\InjectionAwareInterface](/3.2/en/api/Phalcon_Di_InjectionAwareInterface), [Serializable](http://php.net/manual/en/class.serializable.php)

<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/mvc/collection.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
## Methods
final public  **__construct** ([[Phalcon\DiInterface](/3.2/en/api/Phalcon_DiInterface) $dependencyInjector], [[Phalcon\Mvc\Collection\ManagerInterface](/3.2/en/api/Phalcon_Mvc_Collection_ManagerInterface) $modelsManager])
...
protected  **setEventsManager** ([Phalcon\Mvc\Collection\ManagerInterface](/3.2/en/api/Phalcon_Mvc_Collection_ManagerInterface) $eventsManager)
...
public static  **cloneResult** ([Phalcon\Mvc\CollectionInterface](/3.2/en/api/Phalcon_Mvc_CollectionInterface) $collection, *array* $document)

Returns a cloned collection



protected static *array* **_getResultset** (*array* $params, [Phalcon\Mvc\Collection](/3.2/en/api/Phalcon_Mvc_Collection) $collection, *MongoDb* $connection, *boolean* $unique)

Returns a collection resultset



protected static *int* **_getGroupResultset** (*array* $params, [Phalcon\Mvc\Collection](/3.2/en/api/Phalcon_Mvc_Collection) $collection, *MongoDb* $connection)

Perform a count over a resultset



final protected *boolean* **_preSave** ([Phalcon\DiInterface](/3.2/en/api/Phalcon_DiInterface) $dependencyInjector, *boolean* $disableEvents, *boolean* $exists)
...
protected  **addBehavior** ([Phalcon\Mvc\Collection\BehaviorInterface](/3.2/en/api/Phalcon_Mvc_Collection_BehaviorInterface) $behavior)

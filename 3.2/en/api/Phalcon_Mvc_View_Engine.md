...
*implements* [Phalcon\Events\EventsAwareInterface](/3.2/en/api/Phalcon_Events_EventsAwareInterface), [Phalcon\Di\InjectionAwareInterface](/3.2/en/api/Phalcon_Di_InjectionAwareInterface), [Phalcon\Mvc\View\EngineInterface](/3.2/en/api/Phalcon_Mvc_View_EngineInterface)

<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/mvc/view/engine.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
## Methods
public  **__construct** ([Phalcon\Mvc\ViewBaseInterface](/3.2/en/api/Phalcon_Mvc_ViewBaseInterface) $view, [[Phalcon\DiInterface](/3.2/en/api/Phalcon_DiInterface) $dependencyInjector])
...
abstract public  **render** (*mixed* $path, *mixed* $params, [*mixed* $mustClean]) inherited from [Phalcon\Mvc\View\EngineInterface](/3.2/en/api/Phalcon_Mvc_View_EngineInterface)

...
*implements* [Phalcon\Mvc\Router\RouteInterface](/3.2/en/api/Phalcon_Mvc_Router_RouteInterface)

<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/mvc/router/route.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public  **setGroup** ([Phalcon\Mvc\Router\GroupInterface](/3.2/en/api/Phalcon_Mvc_Router_GroupInterface) $group)

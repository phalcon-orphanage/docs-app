...
<a href="https://github.com/phalcon/cphalcon/tree/v3.2.0/phalcon/forms/element/select.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public [Phalcon\Forms\Element](/3.2/en/api/Phalcon_Forms_Element) **setOptions** (*array* | *object* $options)

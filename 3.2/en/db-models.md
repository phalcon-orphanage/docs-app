...
All the queries are internally handled as [PHQL](/3.2/en/db-phql) queries. PHQL is a high-level, object-oriented and SQL-like language. This language provide you more features to perform queries like joining other models, define groupings, add aggregations etc.
...
On Phalcon 3.2.0 and later it is:

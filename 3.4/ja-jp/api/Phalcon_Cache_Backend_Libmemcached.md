...
<a href="https://github.com/phalcon/cphalcon/tree/v3.4.0/phalcon/cache/backend/libmemcached.zep" class="btn btn-default btn-sm">GitHub上のソース</a>

libmemcached バックエンドを使用して、出力フラグメント、PHPデータ、生のデータをキャッシュできます。 デフォルトでは永続的な memcached 接続プールが使用されます。

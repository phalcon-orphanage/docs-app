...
Phalcon\Mvc\Router is the standard framework router. Enrutamiento es el proceso de tomar un punto final URI (la parte del URI que viene después de la URL base) y descomponiéndolo en parámetros para determinar qué módulo, controlador y la acción de ese controlador debería recibir la solicitud

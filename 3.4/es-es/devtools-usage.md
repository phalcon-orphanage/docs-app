...
<h5 class='alert alert-danger' markdown='1'>If you prefer to use the web version instead of the console, this [blog post](https://blog.phalcon.io/post/dont-like-command-line-and-consoles-no-problem) offers more information. </h5>

...
Phalcon forms are integrated with the [validation](/3.4/en/validation) component to offer instant validation. Los validadores incorporados o personalizados se pueden configurar para cada elemento:

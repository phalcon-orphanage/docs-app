...
Phalcon provides encryption facilities via the [Phalcon\Crypt](api/Phalcon_Crypt) component. 此类提供 [openssl](https://www.php.net/manual/en/book.openssl.php) PHP 加密库简单的面向对象的封装器。

...
All the queries are internally handled as [PHQL](/3.4/en/db-phql) queries. PHQL is a high-level, object-oriented and SQL-like language. 这种语言为您提供了更多的功能来执行查询像加入其他模型，定义分组，添加聚合等。

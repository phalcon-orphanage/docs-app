...
| [Phalcon\Config\Adapter\Json](api/Phalcon_Config) | Uses JSON files to store settings.                                                               |
...
| [Phalcon\Config\Adapter\Yaml](api/Phalcon_Config) | Uses YAML files to store settings.                                                               |

...
Before continuing, please be sure you've successfully [installed Phalcon](/3.1/en/installation) and have setup either [nginX](/3.1/en/setup#nginx), [Apache](/3.1/en/setup#apache) or [Cherokee](/3.1/en/setup#cherokee).
...
A more detailed article regarding HTML generation can be [found here](/3.1/en/tags).

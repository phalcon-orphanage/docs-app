...
### Setup
Routing is handled by the [Phalcon\Mvc\Router](api/Phalcon_Mvc_Router) object. [[Info](/3.1/en/routing)]
...
Those changes are outlined in the [rewrite rules](/3.1/en/rewrite-rules).
...
Additional information: [Phalcon\Mvc\Router](api/Phalcon_Mvc_Router) [Info](/3.1/en/routing)

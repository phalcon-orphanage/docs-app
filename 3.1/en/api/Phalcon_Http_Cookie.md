...
*implements* [Phalcon\Http\CookieInterface](/3.1/en/api/Phalcon_Http_CookieInterface), [Phalcon\Di\InjectionAwareInterface](/3.1/en/api/Phalcon_Di_InjectionAwareInterface)

<a href="https://github.com/phalcon/cphalcon/tree/v3.1.0/phalcon/http/cookie.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public [Phalcon\Http\Cookie](/3.1/en/api/Phalcon_Http_Cookie) **setValue** (*string* $value)

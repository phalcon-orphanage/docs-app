...
<a href="https://github.com/phalcon/cphalcon/tree/v3.1.0/phalcon/tag.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public static  **setDI** ([Phalcon\DiInterface](/3.1/en/api/Phalcon_DiInterface) $dependencyInjector)

...
<a href="https://github.com/phalcon/cphalcon/tree/v3.1.0/phalcon/image/adapter.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public  **watermark** ([Phalcon\Image\Adapter](/3.1/en/api/Phalcon_Image_Adapter) $watermark, [*mixed* $offsetX], [*mixed* $offsetY], [*mixed* $opacity])
...
public  **mask** ([Phalcon\Image\Adapter](/3.1/en/api/Phalcon_Image_Adapter) $watermark)

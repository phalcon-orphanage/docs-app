...
<a href="https://github.com/phalcon/cphalcon/tree/v3.1.0/phalcon/mvc/collectioninterface.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
abstract public static  **cloneResult** ([Phalcon\Mvc\CollectionInterface](/3.1/en/api/Phalcon_Mvc_CollectionInterface) $collection, *array* $document)

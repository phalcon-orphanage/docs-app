...
<a href="https://github.com/phalcon/cphalcon/tree/v3.1.0/phalcon/di.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
public  **setInternalEventsManager** ([Phalcon\Events\ManagerInterface](/3.1/en/api/Phalcon_Events_ManagerInterface) $eventsManager)
...
public  **setRaw** (*mixed* $name, [Phalcon\Di\ServiceInterface](/3.1/en/api/Phalcon_Di_ServiceInterface) $rawDefinition)
...
public  **register** ([Phalcon\Di\ServiceProviderInterface](/3.1/en/api/Phalcon_Di_ServiceProviderInterface) $provider)
...
public static  **setDefault** ([Phalcon\DiInterface](/3.1/en/api/Phalcon_DiInterface) $dependencyInjector)
...
protected  **loadFromConfig** ([Phalcon\Config](/3.1/en/api/Phalcon_Config) $config)

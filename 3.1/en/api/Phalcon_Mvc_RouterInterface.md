...
<a href="https://github.com/phalcon/cphalcon/tree/v3.1.0/phalcon/mvc/routerinterface.zep" class="btn btn-default btn-sm">Source on GitHub</a>
...
abstract public  **mount** ([Phalcon\Mvc\Router\GroupInterface](/3.1/en/api/Phalcon_Mvc_Router_GroupInterface) $group)

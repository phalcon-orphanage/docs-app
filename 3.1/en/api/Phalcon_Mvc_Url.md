...
*implements* [Phalcon\Mvc\UrlInterface](/3.1/en/api/Phalcon_Mvc_UrlInterface), [Phalcon\Di\InjectionAwareInterface](/3.1/en/api/Phalcon_Di_InjectionAwareInterface)

<a href="https://github.com/phalcon/cphalcon/tree/v3.1.0/phalcon/mvc/url.zep" class="btn btn-default btn-sm">Source on GitHub</a>

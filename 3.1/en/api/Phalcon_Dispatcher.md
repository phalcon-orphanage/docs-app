...
*implements* [Phalcon\DispatcherInterface](/3.1/en/api/Phalcon_DispatcherInterface), [Phalcon\Di\InjectionAwareInterface](/3.1/en/api/Phalcon_Di_InjectionAwareInterface), [Phalcon\Events\EventsAwareInterface](/3.1/en/api/Phalcon_Events_EventsAwareInterface)

<a href="https://github.com/phalcon/cphalcon/tree/v3.1.0/phalcon/dispatcher.zep" class="btn btn-default btn-sm">Source on GitHub</a>

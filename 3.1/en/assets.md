...
class ControllerBase extends Controller
{
    public function onConstruct()
    {
        $this->assets
            ...
            ->collection('global')
            ->addJs('https://code.jquery.com/jquery-3.1.1.js', false, true)
            ->addFilter(new Jsmin());
    }
}
```
...
Learn more about the Web Server Setup and Routing in their dedicated articles [Web Server Setup](/3.1/en/webserver-setup) and [Routing](/3.1/en/routing).

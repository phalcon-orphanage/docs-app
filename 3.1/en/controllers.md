...
If you're using Phalcon as a full-stack framework, you can read the services provided [by default](/3.1/en/di) in the framework.
...
Learn more about the HTTP environment in their dedicated articles [request](/3.1/en/request) and [response](/3.1/en/response).
...
Controllers automatically act as listeners for [dispatcher](/3.1/en/dispatcher) events, implementing methods with those event names allow you to implement hook points before/after the actions are executed:
